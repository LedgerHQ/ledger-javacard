...
mkdir -p build/classes build/applet build/src/com/btchip/applet/poc 2>/dev/null
cpp -P src/com/btchip/applet/poc/Ripemd160.javap > build/src/com/btchip/applet/poc/Ripemd160.java
javac -g -classpath $JCENV/lib/api_classic.jar -sourcepath src:build/src -d build/classes src/com/btchip/applet/poc/*.java 
